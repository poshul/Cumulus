...
public enum PooledConnectionFactory {
	...
	private PooledConnectionFactory() {
		...
		if (Constants.jdbcUrl==null||Constants.jdbcPassword==null||Constants.jdbcUser==null){
		...
		ConnectionFactory cumulusConnectionFactory= new DriverManagerConnectionFactory(Constants.jdbcUrl, Constants.jdbcUser, Constants.jdbcPassword);
